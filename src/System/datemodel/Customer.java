...
public Customer(String id,String name,String shorttname,String address,String phone,
		String email,String post_id,String account,String bank_name,String fax_id,String managename,String managenamephone)
{
	this.id=id;
	this.name=name;
