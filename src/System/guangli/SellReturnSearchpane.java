...
public class SellReturnSearchpane extends JPanel{
	...
	{
		String[] name=new String[]{"销售退货票号", "商品编号", "商品名称", "规格", "单价",
				"数量", "金额", "客户全称", "销售退货日期", "操作员", "经手人", "结算方式"};
