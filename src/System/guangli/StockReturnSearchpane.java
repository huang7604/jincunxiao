...
import java.awt.*;
public class StockReturnSearchpane extends JPanel{
	...
	{
		String[] name=new String[]{"进货退货票号", "商品编号", "商品名称", "规格", "单价",
				"数量", "金额", "供应商全称", "进货退货日期", "操作员", "经手人", "结算方式"};
